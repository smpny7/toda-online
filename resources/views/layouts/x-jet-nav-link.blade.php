...
@else
    ...
    @if(Auth::user()->attendances()->first()->math1)
        <x-jet-nav-link href="{{ route('class', ['class_key' => 'math1']) }}" :active="request()->is('math1*')">
    ...
    @if(Auth::user()->attendances()->first()->math2)
        <x-jet-nav-link href="{{ route('class', ['class_key' => 'math2']) }}" :active="request()->is('math2*')">
    ...
    @if(Auth::user()->attendances()->first()->math3)
        <x-jet-nav-link href="{{ route('class', ['class_key' => 'math3']) }}" :active="request()->is('math3*')">
    ...
    @if(Auth::user()->attendances()->first()->mathA)
        <x-jet-nav-link href="{{ route('class', ['class_key' => 'mathA']) }}" :active="request()->is('mathA*')">
    ...
    @if(Auth::user()->attendances()->first()->mathB)
        <x-jet-nav-link href="{{ route('class', ['class_key' => 'math1']) }}" :active="request()->is('mathB*')">

<div class="bg-white col-span-1 mb-1 sm:mb-2 px-7 py-7 relative rounded-xl shadow-md">
    ...
    <a class="@if($video->history) bg-gray-200 @else bg-themeColor @endif font-bold h-12 inline-block mt-7 pt-3 rounded-lg shadow-md text-center text-white tracking-widest w-full"

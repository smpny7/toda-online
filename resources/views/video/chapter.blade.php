            ...
            @foreach($videos as $video)
                <div class="bg-white md:flex mt-4 px-5 sm:px-10 py-4 rounded-lg shadow-md">
                    ...
                    <div class="flex flex-none flex-row float-right">
                        ...
                        <p class="font-bold inline-block mr-10 pt-1 text-lg text-right text-themeColor tracking-widest w-10">
                        ...
                        <img
                            ...
                            class="h-7 md:mr-6 mt-1 w-7" alt="Award">
                    </div>
                    <div class="md:flex-none h-9 mt-3 md:mt-0">
                        <a class="bg-themeColor font-bold float-right h-9 inline-block pt-2 rounded-lg shadow-md text-center text-sm text-white tracking-widest w-24"
